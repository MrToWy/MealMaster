...
void _mealPlanAttach(IsarCollection<dynamic> col, Id id, MealPlan object) {
  object.id = id;
  object.entries
      .attach(col, col.isar.collection<MealPlanEntry>(), r'entries', id);
}
...
extension MealPlanQueryFilter
  ...
  QueryBuilder<MealPlan, MealPlan, QAfterFilterCondition> endDateIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MealPlan, MealPlan, QAfterFilterCondition> endDateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MealPlan, MealPlan, QAfterFilterCondition> startDateIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<MealPlan, MealPlan, QAfterFilterCondition> startDateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'startDate',
      ));
...
extension MealPlanQueryLinks
    on QueryBuilder<MealPlan, MealPlan, QFilterCondition> {
  QueryBuilder<MealPlan, MealPlan, QAfterFilterCondition> entries(
  ...
  QueryBuilder<MealPlan, MealPlan, QAfterFilterCondition> entriesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MealPlan, MealPlan, QAfterFilterCondition> entriesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'entries', 0, true, 0, true);
    });
  }

  QueryBuilder<MealPlan, MealPlan, QAfterFilterCondition> entriesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'entries', 0, false, 999999, true);
    });
  }

  QueryBuilder<MealPlan, MealPlan, QAfterFilterCondition> entriesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MealPlan, MealPlan, QAfterFilterCondition> entriesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
