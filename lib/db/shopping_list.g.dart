...
const ShoppingListSchema = CollectionSchema(
  ...
  links: {
    r'entries': LinkSchema(
      id: 5062135062618052232,
      name: r'entries',
      target: r'ShoppingListEntry',
      single: false,
      linkName: r'shoppingList',
    )
  },
  embeddedSchemas: {},
...
void _shoppingListAttach(
  ...
  object.id = id;
  object.entries
      .attach(col, col.isar.collection<ShoppingListEntry>(), r'entries', id);
}
...
extension ShoppingListQueryLinks
    on QueryBuilder<ShoppingList, ShoppingList, QFilterCondition> {
  QueryBuilder<ShoppingList, ShoppingList, QAfterFilterCondition> entries(
      FilterQuery<ShoppingListEntry> q) {
    return QueryBuilder.apply(this, (query) {
